...
def _make_db(path: Path) -> None:
    ...
    con.executemany(
        ...
        [
            (
                "/mem/shared/2026-01-01-a.md", "2026-01-01-a.md",
                "working", "decision-record", "dev", "2026-01-01",
                "never", None, "dev", 512, "abc", "2026-01-01T00:00:00Z",
            ),
            (
                "/mem/shared/2026-02-01-b.md", "2026-02-01-b.md",
                "working", "transient-finding", "research", "2026-02-01",
                "2026-05-01", None, "research", 256, "def", "2026-02-01T00:00:00Z",
            ),
            (
                "/mem/agents/dev/2026-03-01-c.md", "2026-03-01-c.md",
                "session", "session-summary", "dev", "2026-03-01",
                "2026-04-01", None, "dev", 128, "ghi", "2026-03-01T00:00:00Z",
            ),
        ],
    )
    con.executemany(
